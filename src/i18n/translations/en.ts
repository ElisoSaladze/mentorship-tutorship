export const en = {
  ...
  register: {
    ...
    registration: "Registration",
    tutorDescription: "Share your knowledge with students and help them achieve academic success",
    mentorDescription: "Become a mentor and help students in their professional development",
    seekerDescription: "Find a mentor or tutor to achieve your academic and career goals",
    ...
    offerToSeekerHelper: "For example: I can help students with advanced mathematics",
    keywords: "Keywords",
    keywordsHelper: "Enter keywords separated by commas (e.g.: mathematics, physics, programming)",
    tutorNote: "Note: Only students with a weighted average score above 81 can obtain tutor status",
    ...
    courseDescriptionHelper: "Goals, outcomes, content, completion requirements, schedule, meeting format",
    ...
    programEvaluationHelper: "Name the positive aspects of the program and recommendations to improve its effectiveness",
